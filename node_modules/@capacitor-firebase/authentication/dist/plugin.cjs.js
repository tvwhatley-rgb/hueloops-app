...
class FirebaseAuthenticationWeb extends core.WebPlugin {
    ...
    async getIdTokenResult(options) {
        ...
        const idTokenResult = await auth$1.currentUser.getIdTokenResult(options === null || options === void 0 ? void 0 : options.forceRefresh);
    ...
    async verifyBeforeUpdateEmail(options) {
        ...
        return auth.verifyBeforeUpdateEmail(currentUser, options === null || options === void 0 ? void 0 : options.newEmail, options === null || options === void 0 ? void 0 : options.actionCodeSettings);
    }
